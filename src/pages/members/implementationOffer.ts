...
const OFFERS: Record<string, ImplementationOffer> = {
  "wave-scout": {
    ...
    price: 2500,
    checkoutUrl: AGENT_CHECKOUT,
    cta: "Build My Wave Scout System",
  },
  "sales-rider": {
    kind: "checkout",
    label: "AI Agent Systems",
    price: 2500,
    checkoutUrl: AGENT_CHECKOUT,
    cta: "Build My Sales Rider System",
  },
  "content-creator": {
    kind: "checkout",
    label: "AI Agent Systems",
  ...
  "customer-care-cove": {
    ...
    price: 2500,
    checkoutUrl: AGENT_CHECKOUT,
    cta: "Build My Customer Care System",
  },
  "automation-architect": {
    kind: "checkout",
    label: "Automation & AI Workflow Systems",
    price: 2500,
    checkoutUrl: AUTOMATION_CHECKOUT,
