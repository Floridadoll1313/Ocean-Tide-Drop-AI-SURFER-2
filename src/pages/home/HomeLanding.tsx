...
const styles: Record<string, React.CSSProperties> = {
  page: { minHeight: "100vh", background: "#04111f", color: "#f8fafc", fontFamily: "Inter, system-ui, sans-serif" },
  hero: { position: "relative", overflow: "hidden", padding: "92px 20px 110px", background: "radial-gradient(circle at 50% 0%, rgba(0,229,255,.2), transparent 42%), linear-gradient(180deg,#061a2c 0%,#04111f 100%)" },
  ...
  wavePanel: { maxWidth: 1180, margin: "0 auto", padding: "58px 30px", borderRadius: 32, textAlign: "center", border: "1px solid rgba(244,114,182,.22)", background: "radial-gradient(circle at 90% 10%,rgba(244,114,182,.12),transparent 32%),linear-gradient(145deg,#08213a,#061526)" },
  journeyGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(230px,1fr))", gap: 18, marginTop: 34 },
  journeyCard: { padding: 26, borderRadius: 22, background: "rgba(2,15,29,.6)", border: "1px solid rgba(103,232,249,.14)", textAlign: "left" },
  ...
  auditSection: { maxWidth: 1080, margin: "0 auto 90px", padding: "44px 30px", borderRadius: 28, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 24, flexWrap: "wrap", border: "1px solid rgba(34,211,238,.28)", background: "rgba(8,47,73,.42)" },
