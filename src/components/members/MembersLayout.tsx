...
export default function MembersLayout() {
  ...
  return (
    <div
      className="min-h-screen text-white flex bg-cover bg-center relative"
      style={{ backgroundImage: "url('/images/members-deck-bg.png')" }}
    >
      ...
      <div className="relative z-10 flex min-h-screen w-full">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              <h1 className="font-black text-xl">AI SURFER</h1>
              <p className="text-xs text-white/50">Members Ocean</p>
            </div>
          </div>
          ...
          <div className="mt-auto rounded-2xl bg-white/5 p-5 border border-white/10">
            <p className="font-bold">🌊 Surf Tip</p>
